...
import { ShieldAlert, Activity, KeyRound, Mail, ArrowRight } from "lucide-react";
        ...
        <div className="bg-card border border-border shadow-xl rounded-xl p-8 relative overflow-hidden">
          {step === "login" ? (
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input
                              ...
                              placeholder="name@ashikagroup.com"
                              className="pl-9"
                              autoComplete="email"
                              {...field}
                            />
            ...
            <div className="animate-in fade-in slide-in-from-right-8 duration-500 flex flex-col items-center">
              ...
              <Button variant="ghost" size="sm" onClick={() => setStep("login")} className="mt-4">
                Back to login
              </Button>
            </div>
          )}
